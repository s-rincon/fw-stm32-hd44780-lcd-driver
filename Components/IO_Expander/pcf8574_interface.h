...
#ifndef IO_EXPANDER_INTERFACE_H
#define IO_EXPANDER_INTERFACE_H
...
typedef struct pcf8574_i2c_interface_ {
    ...
    /**
     * @brief Initialize the I2C hardware instance
    ...
    /**
     * @brief Deinitialize the I2C hardware instance
     * @param[in] hw_instance Pointer to the hardware-specific I2C instance
